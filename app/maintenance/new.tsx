...
const TEMPLATES: MaintenanceTemplate[] = [
  { id: 'oil_change', title: 'Oil Change', type: 'routine', description: 'Engine oil and filter replacement', default_parts: ['Oil Filter', 'Engine Oil (5 qt)'], estimated_cost_min: 35, estimated_cost_max: 85, interval_miles: 5000, interval_months: 6 },
  { id: 'tire_rotation', title: 'Tire Rotation', type: 'routine', description: 'Rotate tires to equalize wear', estimated_cost_min: 20, estimated_cost_max: 60, interval_miles: 7500, interval_months: 6 },
  { id: 'brake_pads', title: 'Brake Pads', type: 'repair', description: 'Front and/or rear brake pad replacement', default_parts: ['Front Brake Pads', 'Rear Brake Pads'], estimated_cost_min: 150, estimated_cost_max: 400, interval_miles: 40000, interval_months: 48 },
  { id: 'air_filter', title: 'Air Filter', type: 'routine', description: 'Engine air filter replacement', default_parts: ['Engine Air Filter'], estimated_cost_min: 20, estimated_cost_max: 50, interval_miles: 15000, interval_months: 12 },
  { id: 'transmission_fluid', title: 'Transmission Fluid', type: 'routine', description: 'Transmission fluid flush and fill', default_parts: ['Transmission Fluid'], estimated_cost_min: 100, estimated_cost_max: 250, interval_miles: 60000, interval_months: 48 },
  { id: 'coolant_flush', title: 'Coolant Flush', type: 'routine', description: 'Cooling system flush and new coolant', default_parts: ['Coolant/Antifreeze'], estimated_cost_min: 100, estimated_cost_max: 200, interval_miles: 30000, interval_months: 24 },
  { id: 'spark_plugs', title: 'Spark Plugs', type: 'routine', description: 'Spark plug replacement', default_parts: ['Spark Plugs (set)'], estimated_cost_min: 100, estimated_cost_max: 300, interval_miles: 60000, interval_months: 60 },
  { id: 'battery', title: 'Battery', type: 'repair', description: 'Battery replacement', default_parts: ['Car Battery'], estimated_cost_min: 100, estimated_cost_max: 250, interval_months: 48 },
  { id: 'alignment', title: 'Wheel Alignment', type: 'routine', description: 'Four-wheel alignment service', estimated_cost_min: 75, estimated_cost_max: 200, interval_miles: 20000, interval_months: 24 },
];
...
export default function MaintenanceNewScreen() {
  ...
  const applyTemplate = (tpl: MaintenanceTemplate) => {
    setTitle(tpl.title);
    setType(tpl.type);
    setDescription(tpl.description);
    if (tpl.default_parts) setInlineParts(tpl.default_parts);
    const avgCost = ((tpl.estimated_cost_min + tpl.estimated_cost_max) / 2).toFixed(2);
    setLaborCost(avgCost);
  };
      ...
      <ScrollView style={styles.scroll} contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
        <View style={styles.card}>
          ...
          <View style={styles.group}>
            ...
            <TextInput style={styles.input} value={title} onChangeText={setTitle} placeholder="Oil change" placeholderTextColor={colors.textSecondary} />
          </View>
          ...
          <View style={styles.row}>
            ...
            <View style={[styles.group, styles.column]}>
              ...
              <TextInput style={styles.input} value={mileage} onChangeText={setMileage} keyboardType="numeric" placeholder="30500" placeholderTextColor={colors.textSecondary} />
            </View>
          </View>
          ...
          <View style={styles.row}>
            <View style={[styles.group, styles.column]}>
              ...
              <TextInput style={styles.input} value={nextServiceDate} onChangeText={setNextServiceDate} placeholder="YYYY-MM-DD" placeholderTextColor={colors.textSecondary} />
            </View>
            <View style={[styles.group, styles.column]}>
